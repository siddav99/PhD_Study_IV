...
<!-- Well, so I haven't worked much with ordinal outcomes, so you will have to read up on that. I'm more used to the binary outcome setting, in which the definition of an event is much more straightforward. But here's a paper on sample size with multinominal logistic regression that may help https://pubmed.ncbi.nlm.nih.gov/30614028/ -->
...
<!-- Are the odds adjusted for other factors? -->
